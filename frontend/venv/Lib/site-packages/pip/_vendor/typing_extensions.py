...
if sys.version_info >= (3, 12):
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            Such classes are primarily used with templates type checkers that recognize
            structural subtyping (templates duck-typing), for example::
                ...
                func(C())  # Passes templates type check
